  ...
  return (
    <>
      <style>{`
        ...
        .grid-top { display:grid;grid-template-columns:1.4fr 1fr;grid-template-rows:auto auto;gap:1.5px;background:#e0dbd0;border:1.5px solid #e0dbd0;border-radius:16px;overflow:hidden;margin-bottom:4rem; }
        .card-big { grid-row:1/3;background:#f7f5f0;text-decoration:none;color:inherit;display:flex;flex-direction:column;overflow:hidden;transition:background .2s; }
        .card-big:hover { background:#efe9d8; }
        .card-big-img { height:300px;overflow:hidden;background:linear-gradient(135deg,#1c1a17,#2e2a22);display:flex;align-items:center;justify-content:center;font-size:5rem;position:relative; }
        .card-big-img::after { content:'';position:absolute;inset:0;background:linear-gradient(to top,rgba(12,12,11,.6),transparent 50%); }
        .card-big-body { padding:2rem 2.25rem 2.5rem;flex:1;display:flex;flex-direction:column; }
        .card-sm { background:#f7f5f0;text-decoration:none;color:inherit;display:flex;flex-direction:column;padding:2rem 2.25rem;transition:background .2s; }
        ...
        @media(max-width:1024px){ .hero{grid-template-columns:1fr;min-height:auto} .hero-right{display:none} .hero-left{padding:5rem 2rem 4rem} .grid-top{grid-template-columns:1fr} .card-big{grid-row:auto} .grid-3{grid-template-columns:repeat(2,1fr)} }

      ...
      of: [
        {
          ...
          fields: [
            ...
            { name: 'href', title: 'Link URL', type: 'url', description: 'Optioneel; maakt de kaart klikbaar.' },
            {
              ...
              type: 'image',
              options: { hotspot: true },
              description: 'Optioneel; zonder afbeelding blijft de tekstkaart zichtbaar.',
              fields: [{ name: 'alt', type: 'string', title: 'Alt-tekst' }],
            },
          ],
          preview: { select: { title: 'label', subtitle: 'subtitle', media: 'image' } },
        },
      ],
    }),
    defineField({
      ...
      of: [
        {
          ...
          fields: [
            ...
            { name: 'href', title: 'Link URL', type: 'url', description: 'Optioneel; maakt de tegel klikbaar.' },
            {
              ...
              type: 'image',
              options: { hotspot: true },
              description: 'Optioneel; zonder afbeelding blijft de tekst-chip zichtbaar.',
              fields: [{ name: 'alt', type: 'string', title: 'Alt-tekst' }],
            },
          ],
      ...
      of: [
        {
          ...
          fields: [
            { name: 'name', title: 'Naam', type: 'string', validation: (Rule) => Rule.required() },
            {
              ...
              type: 'image',
              options: { hotspot: true },
              description: 'Optioneel merklogo (PNG, JPG of SVG). Zonder logo wordt de merknaam als tekst getoond.',
            },
            { name: 'href', title: 'Link URL', type: 'url', description: 'Optioneel; maakt het merk klikbaar.' },
          ],
          preview: { select: { title: 'name', subtitle: 'href', media: 'logo' } },
        },
      ],
    }),
    defineField({
